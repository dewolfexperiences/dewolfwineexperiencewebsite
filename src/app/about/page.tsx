    ...
    <div className="bg-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-rose-50 via-white to-amber-50">
        <div className="absolute inset-0 opacity-40">
          <div className="absolute -left-10 top-0 h-48 w-48 rounded-full bg-rose-200 blur-3xl" />
          <div className="absolute bottom-0 right-0 h-64 w-64 rounded-full bg-amber-200 blur-3xl" />
        </div>
        ...
        <div className="mx-auto max-w-5xl space-y-12 px-6">
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-lg text-slate-700">
              ...
              <li>Mentorship and national influence across the sommelier community.</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-lg text-slate-700">
              <li>Former National President of the Canadian Association of Professional Sommeliers.</li>
              <li>Sommelier instructor and supporter of Femmes du Vin and Tasting Climate Change.</li>
              <li>Content Manager and Editor for ASI Magazine (Association de la Sommellerie Internationale).</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-lg text-slate-700">
              <li>Roles at Occasions Magazine, NSLC, SaltWire and The Coast.</li>
              <li>Focus on Atlantic Canadian restaurants, producers and culinary culture.</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-lg text-slate-700">
              ...
              <li>Co founder of the Halifax International Wine Festival and Spirit Festival.</li>
              <li>Hosts trips, dinners and tastings that bring producers and guests together.</li>
            </ul>
          </div>
          ...
          <div className="space-y-4 rounded-3xl bg-slate-50 p-8">
            ...
            <Link
              href="/#listen"
              className="inline-flex items-center gap-2 text-base font-semibold text-rose-700 transition hover:text-rose-600"
            >
